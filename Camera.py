...
class Camera(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.sound_crowd_file = fllc.SOUND_PATH+'crowd-of-boys-cheering.mp3'
        self.sound_crowd_booing_file = fllc.SOUND_PATH+'crowd_booing.mp3'
        ...
        self.description.setFont(QFont("Roboto",18))
