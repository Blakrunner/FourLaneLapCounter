...
_path_ = dirname(realpath(__file__))
...
class Settings(QObject):
    ...
    TRACKRECORD = 5000
    TRACKRECORDHOLDER = "Friday"
    race_position = ['None','None','None','None']
    start_loop = 0
    end_loop = 0
    var_motion = 0
    about_text = "<p>Designed for <b>AFX TOMY</b> slot car four lane sets. Created to give easy access for four lane lap counting and lap timing by using mobile phone or tablet. Could be used for other slot car tracks. </p>"
    about_text += "<p><b>Racers Selector</b></p><p>Enter each racer name in corresponding lane, select color of car, or just choose color liked. </p><p>Empty name to disable that lane, eg. Only one player, put your name in and leave all other fields empty. Save setup and then race against the time in Free Racing</p>"
    about_text += "<p><b>Motion Dectector</b></p><p> <i>Motion detection</i> uses the camera to trigger the lap counting and lap timing. Here are the setting descriptions...</p><p>- <i>Anti Min</i> and <i>Anti Max</i> are for setting minium and maximum shake area</p><p>- <i>Delay</i> is for timer delay after first trigger on motion detection, stops double lap count. Can be set to suit lap times</p>"
    about_text += "<p>- <i>Kernal</i> is for area size of GaussianBlur</p><p>- <i>Range</i> is the the thresh hold area</p><p>- <i>Contour</i> is for the minium area to detect</p>"
    ...
    def RestoreSettings(self):
        ...
        self.race_position = ['None','None','None','None']
