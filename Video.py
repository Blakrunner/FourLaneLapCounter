...
class VideoWidget(QWidget):
    ...
    def drawOverlay(self, qpainter, w, h):
        ...
        if self.show_laps:
            painter.setPen(QColor(Qt.white))
            laps_racer1 = self.parent.video_widget.racer1.getLap()
            painter.drawText(50,170,"Lap "+str(laps_racer1))
            laps_racer2 = self.parent.video_widget.racer2.getLap()
            painter.drawText(lanewidth+50,170,"Lap "+str(laps_racer2))
            laps_racer3 = self.parent.video_widget.racer3.getLap()
            painter.drawText((lanewidth*2)+50,170,"Lap "+str(laps_racer3))
            laps_racer4 = self.parent.video_widget.racer4.getLap()
            painter.drawText((lanewidth*3)+50,170,"Lap "+str(laps_racer4))
        if self.show_time:
            painter.setFont(QFont('Roboto',14))
            painter.setPen(QColor(Qt.yellow))
            painter.drawText(15,370,"Time:{: .3f}".format(self.parent.video_widget.racer1.getTime()/1000))
            painter.drawText(lanewidth+15,370,"Time:{: .3f}".format(self.parent.video_widget.racer2.getTime()/1000))
            painter.drawText((lanewidth*2)+15,370,"Time:{: .3f}".format(self.parent.video_widget.racer3.getTime()/1000))
            painter.drawText((lanewidth*3)+15,370,"Time:{: .3f}".format(self.parent.video_widget.racer4.getTime()/1000))
            '''
            painter.setPen(QColor(Qt.white))
            best1 = self.parent.video_widget.racer1.getBestTime()
            painter.drawText(10,300,"Best:{:.3f}".format(best1/1000))
            best2 = self.parent.video_widget.racer2.getBestTime()
            painter.drawText(lanewidth+10,300,"Best:{:.3f}".format(best2/1000))
            best3 = self.parent.video_widget.racer3.getBestTime()
            painter.drawText((lanewidth*2)+10,300,"Best:{:.3f}".format(best3/1000))
            best4 = self.parent.video_widget.racer4.getBestTime()
            painter.drawText((lanewidth*3)+10,300,"Best:{:.3f}".format(best4/1000))
            painter.setPen(self.parent.video_widget.racer1.getLastTimeColor())
            last1 =self.parent.video_widget.racer1.getLastTime()
            painter.drawText(10,440,"Last:{:.3f}".format(last1/1000))
            painter.setPen(self.parent.video_widget.racer2.getLastTimeColor())
            last2 = self.parent.video_widget.racer2.getLastTime()
            painter.drawText(lanewidth+10,440,"Last:{:.3f}".format(last2/1000))
            painter.setPen(self.parent.video_widget.racer3.getLastTimeColor())
            last3 = self.parent.video_widget.racer3.getLastTime()
            painter.drawText((lanewidth*2)+10,440,"Last:{:.3f}".format(last3/1000))
            painter.setPen(self.parent.video_widget.racer4.getLastTimeColor())
            last4 = self.parent.video_widget.racer4.getLastTime()
